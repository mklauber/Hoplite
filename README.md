...
The valid actions for the hero at this time, are `Move` or `Jump`.  The `target` will take the form of `{int},{int}`, e.g. `1,0`, `10,-1`.  All cells have their target displayed on them.
